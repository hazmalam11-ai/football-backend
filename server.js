...
const fantasygameweekRoutes = require("./routes/fantasyLeaderboardRoutes);
appLeaderboardRoutesoutesoutesoutes);
app.use("/fantasyoutesoutesrdRoutes)sst fantasyLeaderboardRoutes = require("./routes/fantasyLeaderboard");
